...
public String getPpProductID() {
return ppProductID;
}

public void setPpProductID(String ppProductID) {
...
public String getPpTxnExpiryDateTime() {
return ppTxnExpiryDateTime;
}

public void setPpTxnExpiryDateTime(String ppTxnExpiryDateTime) {
this.ppTxnExpiryDateTime = ppTxnExpiryDateTime;
}
